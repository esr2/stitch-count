...
function createProject() {
    let secondaryCounter1 = new Counter("border", 1 /* index */, [
        new Note(3, "note for row 3"),
        new Note(4, "note for row 4"),
    ], 1 /* startIndex */, 3 /* endIndex */);
    let secondaryCounter2 = new Counter("panel", 1 /* index */, [
        new Note(3, "note for row 3"),
        new Note(2, "note for row 2"),
    ]);
    let secondaryCounter3 = new Counter("third", 1 /* index */, [
        new Note(5, "note for row 5"),
    ], 3 /* startIndex */, 7 /* endIndex */, true /* showResets */);
